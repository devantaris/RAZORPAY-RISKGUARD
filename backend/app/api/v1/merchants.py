...
class ThresholdOverride(BaseModel):
    offset: float = Field(..., ge=-0.15, le=0.15,
                          description="Signed offset from base 0.80 threshold")


@router.get("/merchants/{merchant_id}/threshold",
